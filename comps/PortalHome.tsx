...
export default function PortalHome() {
  ...
  return (
    ...
    >
      ...
      <p>
        user with name, email, photo and if availbe phone number is
      ...
      {/* TODO: need a concept of completed/not completed, should indicate + form should disappear if already done */}
